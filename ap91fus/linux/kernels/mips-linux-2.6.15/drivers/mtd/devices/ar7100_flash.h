...
int ar7100_flash_erase(struct mtd_info *mtd,struct erase_info *instr);
int ar7100_flash_read(struct mtd_info *mtd, loff_t from, size_t len, size_t *retlen ,u_char *buf);
int ar7100_flash_write(struct mtd_info *mtd, loff_t to, size_t len, size_t *retlen, const u_char *buf);
void ar7100_spi_sector_erase(uint32_t addr);
#endif /*_AR7100_SPI_H*/
